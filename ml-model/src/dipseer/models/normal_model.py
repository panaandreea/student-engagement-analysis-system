...
def build_dipseer_model():
    ...
    attention_output = layers.Dense(3, activation='softmax', name='att_output')(x)
...
def get_callbacks():
    os.makedirs("checkpoints/normal", exist_ok=True)
    checkpoint_path = "checkpoints/normal/best_model.h5"
